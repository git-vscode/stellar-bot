...
client.user.setActivity(`?help || ${client.guilds.cache.size} Servers `, { type: "STREAMING", url: 'https://twitch.tv/invisible.ok' })
...
const fs = require('fs')
 ...
 client.on('guildCreate', guild =>{
    ...
    const channelId = '953788138319396925'; //put your channel ID here
...
client.on('guildDelete', guild =>{
    const channelId = '953788138319396925';//add your channel ID
